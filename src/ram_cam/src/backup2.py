...
def calc_waypoints(tb_coord, crate_coord, destination_coord):
  ...
  back_out_waypoint = [push_waypoint[0] - (pp0c_to_crate_direction * (safety_gap + push_offest)), push_waypoint[1] - (post_push_direction * (safety_gap + push_offest))]
  ...
  while not rospy.is_shutdown():
    try:
      ...
      if waypoints: # move to next waypoint
        ...
        # control_command = zero_vec() # TODO: UNCOMMENT
      else:
